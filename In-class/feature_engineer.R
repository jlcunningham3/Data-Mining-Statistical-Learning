...
load_ercot = read.csv("/Users/jack/Documents/GitHub/Data-Mining-Statistical-Learning/In-class/ercot/load_data.csv")

# Now weather data at the KHOU weather station
# temps in F
load_temperature = read.csv("/Users/jack/Documents/GitHub/Data-Mining-Statistical-Learning/In-class/ercot/load_temperature.csv")
