...
CAhousing = read.csv('/Users/jack/Documents/GitHub/Data-Mining-Statistical-Learning/In-class/CAhousing.csv')
...
pen2ref = read.table('/Users/jack/Documents/GitHub/Data-Mining-Statistical-Learning/In-class/pen2ref.txt', header=TRUE)
head(pen2ref)
