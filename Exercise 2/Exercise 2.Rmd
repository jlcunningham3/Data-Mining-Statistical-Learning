...
I don't think this dataset is appropriate for building a predictive model of defaults. Instead, I would recommend the bank use a dataset consisting of a random sample of loans in the bank's overall portfolio.
...
# RMSE table
RMSE3 = tibble("model" = c("lm1", "lm2", "lm3", "lm4", "lm5", "lm_lasso"), "RMSE" = c(rmse(lm1, Hdev_test), rmse(lm2, Hdev_test), rmse(lm3, Hdev_test), rmse(lm4, Hdev_test), rmse(lm5, Hdev_test), rmse(lm_lasso, Hdev_test)))
...
RMSE4.1 = kable(RMSE4, caption = "Average RMSE of three best models through 10 train/test splits")
RMSE4.1
