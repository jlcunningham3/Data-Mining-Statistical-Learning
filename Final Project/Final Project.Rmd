...
In general, a major limitation of our data is the lack of information on occupancy or market reactions. Despite our efforts to find data that includes these parameters, it appears that the company has imposed restrictions on the publication of information regarding this factor. This limitation may affect the accuracy and completeness of our analysis, as the occupancy rate and market dynamics are important factors in understanding the pricing dynamics of the accommodation market.

A final hypothesis for the high RMSE for price is that Airbnb pricing in New York City is highly idiosyncratic. Many hosts have other jobs and view hosting as a side gig. As a result, they may lack expertise in the real estate field and struggle with determining precise pricing. In contrast, hosts with longer-term listings or hosts with many listings may set prices more competitively and responsively to the market, leading to greater predictability in pricing. We also don't know which rooms were rented at the listed price and which were not - if we could build a model predicting the "market-clearing" prices of Airbnb listings, we might be able to achieve lower error.
...
It is important to note that there may be a difference between the importance of a variable to hosts and travelers, and its effect on the prediction of price. For example, we do not observe a significant effect of "kitchen" on our model's performance, but it could be an important factor for guests. Our model does not make any claims about a causal relationship between the factors that are most important for prediction and the factors that are most important to hosts and travelers.
