...
We have four datasets that we've combined into one. Each dataset contains the entire set of scraped NYC AirBnB listings at the following dates: June 15, 2022; September 15, 2022; December 15, 2022; and March 15, 2023. The data contain 70+ variables and more than 160,000 total observations (roughly 40,000 per quarter). These data come from InsideAirbnb: http://insideairbnb.com/get-the-data/.
...
The below plots give a sense of some of the important variables in this dataset, including frequency of listings of each room type and in each borough, and the distribution of review scores (heavily right-skewed).
